...
OUTPUT_FILE = "data/processed/station_model_results.csv"
...
def main():
    ...
    print("=" * 60)
    print("STATION-LEVEL MODEL EVALUATION")
    print("=" * 60)
    ...
    for station_id in sorted(df["station_id"].unique()):
        ...
        #
        # This is important:
        # target_next_hour at time t = value at t+1
        # persistence prediction at time t = value at t
        #
        # Therefore we use "value", NOT "lag_1".
        # -------------------------------------------------
